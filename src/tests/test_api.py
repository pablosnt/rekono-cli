...
class ApiTest(RekonoCommandTest):
    ...
    unit_tests = [
        ...
        },
        {
            ...
            "output": RekonoCommandTest._expected_output_with_headers(
                "GET", 200, RekonoMock.headers, RekonoMock.data
            ),
        },
        {"arguments": ["api", "get", "--status-code", "entities/1"], "output": "200"},
        {"arguments": ["api", "get", "--quiet", "entities/1"]},
        {
            "arguments": [
                ...
                "get",
                "--json",
                RekonoCommandTest.testing_filepath,
                "entities/1",
            ],
            "output": RekonoCommandTest._json_body(RekonoMock.data),
        },
    ...
    @mock.patch(
        "rekono.framework.commands.command.Rekono.get", RekonoMock.get_multiple_entities
    )
