...
def install_postgresql() -> str:
    ...
    postgresql_query(f'GRANT ALL PRIVILEGES ON {DB_DATABASE} TO {DB_USER};')    # Grant permissions for the Rekono user
    return password
